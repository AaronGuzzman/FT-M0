...
//   return suma;
  ...
  var suma= numeros.reduce((antes, despues) => { 
...
function promedioResultadosTest(resultadosTest) {
  ...
  // var suma= resultadosTest.reduce((antes, despues) => { 
  //   return antes + despues;
...
if(numeroDeDia===7 || numeroDeDia===1) return semana[1]
